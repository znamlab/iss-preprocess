...
def register_tile_to_ref(
    ...
    Args:
        ...
        use_masked_correlation (bool, optional): Use masked correlation to register.
            Defaults to False.
        overview_shifts_to_tile (bool, optional): Whether to convert the overview shifts
            generated by stitch_and_register to individual tile shifts. Only use if
            registered image does not have the same shape as reference. Defaults to False.
